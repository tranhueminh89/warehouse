...
@section('title')
    {!! env('COMPANY_NAME') !!} | @lang('viewrestock.View Restock')
@endsection
...
@section('content')
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">Dispatch Information</h3>
                    <span class="pull-right">
                        <!-- Tabs -->
                        <ul class="nav panel-tabs">
                            <li class="active"><a href="#tab1" data-toggle="tab">Dispatch Information</a></li>
                            <li><a href="#tab2" data-toggle="tab">Mark As Defective</a></li>
        ...
        <div class="panel-body">
            <div class="tab-content">
                <div class="tab-pane active" id="tab1">
                    ...
                    <div class="col-md-8">
                        Product Name : {{$restock->product->productName}}
                        <hr/>
                        Restocked By : {{$restock->supplier->supplierName}}
                        <hr/>
                        Dispatched Amount : {{$restock->amount}}
                        <hr/>
                    </div>
