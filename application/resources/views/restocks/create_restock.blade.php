        ...
        <div class="panel panel-default cls-panel">
            <div class="panel-heading">
                <h3 class="panel-title">
                    {!! Helper::translateAndShorten('Restock Items','createrestock',100)!!}
                </h3>
            </div>
            @if(isset($restock))
            ...
            <div class="panel-body">
                ...
                <div class="form-group{!! $errors->has('productID') ? ' has-error' : '' !!}">
                    {!! Form::label('productID',  trans('createrestock.Select Product To Restock') ) !!}
                ...
                <div class="form-group{!! $errors->has('warehouseId') ? ' has-error' : '' !!}">
                    {!! Form::label('warehouseId', trans('createrestock.Warehouse to Restock item')) !!}
                    <div class="input-group">
                ...
                <div class="form-group{!! $errors->has('supplierID') ? ' has-error' : '' !!}">
                    {!! Form::label('supplierID',trans('createrestock.Suplier Name')) !!}
                    <div class="input-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('itemCost') ? ' has-error' : '' !!}">
                            {!! Form::label('itemCost',trans('createrestock.Item Cost (Total cost for items)')) !!}
                            <div class="input-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('unitCost') ? ' has-error' : '' !!}">
                            {!! Form::label('unitCost',trans('createrestock.Unit Cost') ) !!}
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-money"></i></span>
                ...
                <div class="form-group{!! $errors->has('amount') ? ' has-error' : '' !!}">
                    {!! Form::label('amount',trans('createrestock.Number of Items')) !!}
                    <div class="input-group">
                ...
                <div class="form-group{!! $errors->has('remarks') ? ' has-error' : '' !!}">
                    {!! Form::label('remarks',trans('createrestock.Remarks')) !!}
                    <div class="input-group">
                ...
                <div class="col-md-12">
                    <div class="col-md-12">
                        <div class="form-group{!! $errors->has('image') ? ' has-error' : '' !!}">
                            <div class="text-center"> {!! Form::label('image',  trans('createrestock.Upload zip of receipts') ) !!}</div>
            ...
            <div class="panel-footer">
                ...
                <button class="btn btn-flat bg-green save_form btn-block">@lang('createrestock.Record Restock')</button>
            </div>
            {!! Form::close() !!}
        </div>
    </div>
