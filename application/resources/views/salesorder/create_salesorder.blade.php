...
@section('title')
    {!!env('COMPANY_NAME')!!} | @lang('createsalesorder.Sales Order')
@endsection

@section('heading')
    @lang('createsalesorder.Sales Order')
@endsection
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group{!! $errors->has('customerId') ? ' has-error' : '' !!}">
                    {!! Form::label('customerId',  trans('createinvoice.Company Name') ) !!}
            ...
            <div class="col-md-6">
                <div class="form-group{!! $errors->has('contactId') ? ' has-error' : '' !!}">
                    {!! Form::label('contactId',  trans('createinvoice.Contact Person') ) !!}
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                ...
                <div class="panel panel-default cls-panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            @lang('createsalesorder.Extra Details')
                        </h3>
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group{!! $errors->has('onHold') ? ' has-error' : '' !!}">
                            {!! Form::label('onHold',  trans('createsalesorder.Hold Items') ) !!}
                            <div class="input-group">
                        ...
                        <div class="form-group{!! $errors->has('generatePackingSlip') ? ' has-error' : '' !!}">
                            {!! Form::label('generatePackingSlip',  trans('createsalesorder.Generate Packing Slip') ) !!}
                            <div class="input-group">
                        ...
                        <div class="form-group{!! $errors->has('emailCustomer') ? ' has-error' : '' !!}">
                            {!! Form::label('emailCustomer',  trans('createsalesorder.Email Customer') ) !!}
                            <div class="input-group">
                        ...
                        <div class="form-group{!! $errors->has('paymentMethod') ? ' has-error' : '' !!}">
                            {!! Form::label('paymentMethod',  trans('createsalesorder.Payment Method') ) !!}
                            <div class="input-group">
                        ...
                        <div class="form-group{!! $errors->has('paymentTerms') ? ' has-error' : '' !!}">
                            {!! Form::label('paymentTerms',  trans('createsalesorder.Payment Terms') ) !!}
                            <div class="input-group">
                        ...
                        <div class="form-group{!! $errors->has('delivery') ? ' has-error' : '' !!}">
                            {!! Form::label('delivery', 'Mark for Delivery') !!}
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-truck"></i></span>
                        ...
                        <div class="form-group{!! $errors->has('remark') ? ' has-error' : '' !!}">
                            {!! Form::label('remark', trans('createsalesorder.Remarks') ) !!}
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-comment"></i></span>
                        ...
                        <button type="submit"
                                class="btn btn-flat bg-green save_form btn-block">@lang('createsalesorder.Save')</button>
                    </div>
                </div>
            </div>
        </div>
