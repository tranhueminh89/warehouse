        ...
        <!-- Users-->
            @can('glance', \App\User::class)
                <li {{ HTML::current('user/*', 'user/*') }}>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li {{ HTML::current('user/stock/deleted', 'user/stock/deleted') }}><a
            ...
            @can('glance', \App\Currency::class)
                <li {{ HTML::current('currency/*', 'currency/*') }}>
                    <a href="#">
                        <i class="fa fa-money"></i> <span>Currency Settings  </span> <i
                                class="fa fa-angle-left pull-right"></i>
                        <span class="label label-primary pull-right"></span>
                    </a>
                    <ul class="treeview-menu">
            ...
            <!-- <li {{ HTML::current('updates/*', 'updates/*') }}>



                    <li {{ HTML::current('updates', 'updates') }}><a href="{{url('updates')}}"><i
                                    class='fa fa-users'></i>
                            View Updates/HotFix</a></li>
