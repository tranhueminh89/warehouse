...
@section('title')
    {!!env('COMPANY_NAME')!!} | @lang('createproduct.Add Product')
@endsection
        ...
        <div id="create_product">
            <div class="panel-body">
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('productName') ? ' has-error' : '' !!}">
                            {!! Form::label('productName',  trans('createproduct.Product Name') ) !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('productSerial') ? ' has-error' : '' !!}">
                            {!! Form::label('productSerial', trans('createproduct.Product Serial Number')) !!}
                            <div class="input-group">
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('amount') ? ' has-error' : '' !!}">
                            {!! Form::label('amount', trans('createproduct.Initial Amount of Item in Stock')) !!}
                            <div class="input-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('reorderAmount') ? ' has-error' : '' !!}">
                            {!! Form::label('reorderAmount', trans('createproduct.Reorder Stock Amount')) !!}
                            <div class="input-group">
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('location') ? ' has-error' : '' !!}">
                            {!! Form::label('location', trans('createproduct.Product Location in Store')) !!}
                            <div class="input-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('expiryDate') ? ' has-error' : '' !!}">
                            {!! Form::label('expiryDate', trans('createproduct.Expiration Date')) !!}
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                <date name="expiryDate"></date>
                            </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('barcode') ? ' has-error' : '' !!}">
                            {!! Form::label('barcode', trans('createproduct.Barcode')) !!}
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-barcode"></i></span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('qrcode') ? ' has-error' : '' !!}">
                            {!! Form::label('qrcode', trans('createproduct.QrCode')) !!}
                            <div class="input-group">
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('unitCost') ? ' has-error' : '' !!}">
                            {!! Form::label('unitCost', trans('createproduct.Unit Cost')) !!}
                            <div class="input-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('categoryId') ? ' has-error' : '' !!}">
                            {!! Form::label('categoryId', trans('createproduct.Category')) !!}
                            <div class="input-group">
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('productSku') ? ' has-error' : '' !!}">
                            {!! Form::label('productSku', trans('createproduct.Product SKU')) !!}
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-barcode"></i></span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('productTaxRate') ? ' has-error' : '' !!}">
                            {!! Form::label('productTaxRate', trans('createproduct.Product Tax Rate')) !!}
                            <div class="input-group">
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('productWeight') ? ' has-error' : '' !!}">
                            {!! Form::label('productWeight', trans('createproduct.Product Weight')) !!}
                            <div class="input-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('productMeasurementUnit') ? ' has-error' : '' !!}">
                            {!! Form::label('productMeasurementUnit', trans('createproduct.Product Measurement Unit')) !!}
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-balance-scale"></i></span>
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('productSpecification') ? ' has-error' : '' !!}">
                            {!! Form::label('productSpecification', trans('createproduct.Product Specification')) !!}
                            <div class="input-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('sellingPrice') ? ' has-error' : '' !!}">
                            {!! Form::label('sellingPrice', trans('createproduct.Selling Price')) !!}
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-money"></i></span>
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('productCurrency') ? ' has-error' : '' !!}">
                            {!! Form::label('productCurrency', 'Product Currency') !!}
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-money"></i></span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('usesMultipleStorage') ? ' has-error' : '' !!}">
                            {!! Form::label('usesMultipleStorage',trans('createproduct.Enable Multi Storage') ) !!}
                            <div class="input-group">
                ...
                <div class="row">
                    ...
                    <div v-if="storagetype == 1" class="col-md-12 ">
                        <hr/>
                        {!! trans('createproduct.Multiple Storage Locations') !!} :
                ...
                @if(isset($product))
                    <upload image_url="{{url('photo/')}}" id={{$product->id}} url="{{url('product/upload/photo/'.$product->id)}}" token="{!! csrf_token() !!}">
                    </upload>
                @endif
            ...
            <div class="panel-footer">
                <button type="submit" class="btn btn-flat bg-green save_form btn-block"><i
                            class="fa fa-save"></i> {{ $title }}</button>
            </div>
            {!! Form::close() !!}
        </div>
