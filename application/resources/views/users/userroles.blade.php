...
@section('title')
    {!! env('COMPANY_NAME') !!} | @lang('userroles.User Roles')
@endsection



@section('content')
    <h1 class="text-center">@lang('userroles.User Roles')</h1>
    <hr/>
    ...
    <div class="panel panel-default cls-panel">
        ...
        <div class="panel-footer">
            <button type="submit" class="btn btn-flat bg-green btn-block">Save Role</button>
        </div>
    </div>
    {!! Form::close() !!}
    ...
    <table class="table table-paper table-condensed table-bordered">
        ...
        <tr>
            <th>#</th>
            <th>@lang('userroles.Name')</th>
            <th>@lang('userroles.Description')</th>
            <th>@lang('userroles.Date Created')</th>
            <th>@lang('userroles.Date Updated')</th>
            <th>Actions</th>
        </tr>
        </thead>
        <tbody>
            ...
            <tr class="">
                ...
                <td>
                    <div aria-label="Actions" role="group" class="btn-group">
                        <a href="#!" class="open-popup-link btn btn-flat bg-red"
                           data-url="{{action('RoleController@destroy', array('id'=>$role->id))}}"><i
