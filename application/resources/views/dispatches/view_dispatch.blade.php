...
@section('title')
    {!!env('COMPANY_NAME')!!} | @lang('viewdispatch.View Dispatch')
@endsection
@section('heading')
    @lang('viewdispatch.View Dispatch')
@endsection
...
@section('content')
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">@lang('viewdispatch.Dispatch Information')</h3>
            <span class="pull-right">
                        <!-- Tabs -->
                        <ul class="nav panel-tabs">
                            <li class="active"><a href="#tab1"
                                                  data-toggle="tab">@lang('viewdispatch.Dispatch Information')</a></li>
                            <li><a href="#tab2" data-toggle="tab">@lang('viewdispatch.Mark As Defective')</a></li>
        ...
        <div class="panel-body">
            <div class="tab-content">
                <div class="tab-pane active" id="tab1">
                    ...
                    <div class="col-md-8">
                        @lang('viewdispatch.Product Name') : {{$dispatch->product->productName}}
                        <hr/>
                        @lang('viewdispatch.Dispatched To') : {{($dispatch->staff) ? $dispatch->staff->name : ''}}
                        <hr/>
                        @lang('viewdispatch.Dispatched Amount') : {{$dispatch->amount}}
                        <hr/>
                    </div>
                ...
                <div class="tab-pane" id="tab2">
                    <div class="alert alert-info">
                        Please not that once item is marked as defective it is returned to store automatically
                    </div>


                    <div class="form-group{!! $errors->has('isDefective') ? ' has-error' : '' !!}">
                        {!! Form::label('isDefective', 'Is Item Defective') !!}
                    ...
                    <div class="form-group{!! $errors->has('defectRemark') ? ' has-error' : '' !!}">
                        {!! Form::label('defectRemark', 'Defect Remark') !!}
                        <div class="input-group">
        ...
        <div class="panel-footer">
            <button type="submit" class="btn btn-flat bg-green btn-block">Save Changes</button>
        </div>
