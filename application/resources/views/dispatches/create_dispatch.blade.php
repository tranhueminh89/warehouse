...
@section('title')
    {!!env('COMPANY_NAME')!!} | @lang('createdispatch.Dispatch Item')
@endsection
@section('heading')
    Dispatch Product
@endsection
        ...
        <div class="panel panel-default cls-panel" id="accordion" role="tablist" aria-multiselectable="true">
            <div class="panel-heading" role="tab" id="dispatchform">
                <h3 class="panel-title" data-toggle="collapse" data-parent="#accordion" href="#collapseOne"
                    ...
                    {!! Helper::translateAndShorten('Dispatch a Product','createdispatch',50)!!}
                </h3>
            </div>
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="dispatchform">
                ...
                <div class="panel-body">
                    <div class="form-group{!! $errors->has('dispatchedItem') ? ' has-error' : '' !!}">
                        {!! Form::label('dispatchedItem',  trans('createdispatch.Item to Dispatch') ) !!}
                    ...
                    <div class="form-group{!! $errors->has('dispatchedTo') ? ' has-error' : '' !!}">
                        {!! Form::label('dispatchedTo', trans('createdispatch.Dispatched To').' (Add Staff in Staff Module)') !!}
                        <div class="input-group">
                    ...
                    <div class="form-group{!! $errors->has('amount') ? ' has-error' : '' !!}">
                        {!! Form::label('amount', trans('createdispatch.Dispatched Amount')) !!}
                        <div class="input-group">
                    ...
                    <div class="form-group{!! $errors->has('remarks') ? ' has-error' : '' !!}">
                        {!! Form::label('remarks', trans('createdispatch.Remarks')) !!}
                        <div class="input-group">
                ...
                <div class="panel-footer">
                    <button type="submit"
                            class="btn btn-flat bg-green save_form  btn-block">@lang('createdispatch.Dispatch')</button>
                </div>
