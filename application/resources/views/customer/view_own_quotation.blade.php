...
@section('title')
    {!!env('COMPANY_NAME')!!} | Quotation {{$salesOrder->orderNo}}
@endsection
                ...
                <div class="btn-group text-center" role="group" aria-label="...">
                    @if($salesOrder->approved != 1)
                        <a href="{{action('CustomerFrontendController@approveQuotation', array('order'=>$salesOrder->orderNo))}}"
                           class="btn btn-flat bg-green"><i class="fa fa-check"></i> Approve Quotation</a>
                    @endif
            ...
            <div class="quote">
                <div id="details" class="clearfix">
                    ...
                    <div id="invoice">
                        ...
                        <div class="date">@lang('viewsalesorder.All Cost in'): <b>{{$salesOrder->currencyTypeText}}</b>
                        </div>
                    </div>
                </div>
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th class="tax">@lang('viewsalesorder.Tax')</th>
                    ...
                    <tr>
                        <td colspan="3"></td>
                        <td colspan="2">@lang('viewsalesorder.SUBTOTAL')</td>
                        <td>{{number_format($salesOrder->items->sum('convertedPrice'),2)}}</td>
                    </tr>
                    <tr>
                        <td colspan="3"></td>
                        <td colspan="2">@lang('viewsalesorder.TAX')</td>
                        <td> {{number_format($salesOrder->items->sum('tax'),2)}}</td>
                    </tr>
                    <tr>
                        <td colspan="3"></td>
                        <td colspan="2">@lang('viewsalesorder.GRAND TOTAL')</td>
