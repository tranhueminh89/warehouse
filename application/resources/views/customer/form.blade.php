        ...
        <div class="panel panel-default cls-panel">
            <div class="panel-heading">
                <h3 class="panel-title">
                    @lang('createcustomer.Customer Details')
                </h3>
            </div>

            <div class="panel-body">
                <div class="form-group{!! $errors->has('companyName') ? ' has-error' : '' !!}">
                    {!! Form::label('companyName', trans('createcustomer.Company')) !!}
                ...
                <div class="form-group{!! $errors->has('companyCurrency') ? ' has-error' : '' !!}">
                    {!! Form::label('companyCurrency',  trans('createcustomer.Company Currency') ) !!}
                    <div class="input-group">
                ...
                <div class="form-group{!! $errors->has('country') ? ' has-error' : '' !!}">
                    {!! Form::label('country',  trans('createcustomer.Country') ) !!}
                    <div class="input-group">
                ...
                <div class="form-group{!! $errors->has('city') ? ' has-error' : '' !!}">
                    {!! Form::label('city',  trans('createcustomer.City') ) !!}
                    <div class="input-group">
                ...
                <div class="form-group{!! $errors->has('customerType') ? ' has-error' : '' !!}">
                    {!! Form::label('customerType',  trans('createcustomer.Customer Type') ) !!}
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-money"></i></span>
        ...
        <div class="panel panel-default cls-panel">
            ...
            <div class="panel-body">
                <div class="form-group{!! $errors->has('creditLimit') ? ' has-error' : '' !!}">
                    {!! Form::label('creditLimit',  trans('createcustomer.Credit Limit') ) !!}
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-money"></i></span>
                ...
                <div class="form-group{!! $errors->has('days') ? ' has-error' : '' !!}">
                    {!! Form::label('days',  trans('createcustomer.Credit Limit Days') ) !!}
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-money"></i></span>
                ...
                <div class="form-group{!! $errors->has('active') ? ' has-error' : '' !!}">
                    {!! Form::label('active',  trans('createcustomer.Active') ) !!}
                    <div class="input-group">
                ...
                <div class="form-group{!! $errors->has('disableReason') ? ' has-error' : '' !!}">
                    {!! Form::label('disableReason',  trans('createcustomer.Disable Reason') ) !!}
                    <div class="input-group">
                ...
                <div class="form-group{!! $errors->has('companyEmail') ? ' has-error' : '' !!}">
                    {!! Form::label('companyEmail',  trans('createcustomer.Company Email') ) !!}
                    <div class="input-group">
    ...
    <div id="app">
        <div class="col-md-12">
            <div class="panel panel-default cls-panel">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        @lang('createcustomer.Customer Contacts')
                        (@lang('createcustomer.You can add multiple Contact People here'))
                    </h3>
                </div>
                ...
                <div class="form-group">
                    <label for="customerName">@lang('createcustomer.Customer Name')</label>
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                    ...
                    <div class="form-group">
                        <label for="telephoneNumber">@lang('createcustomer.Telephone Number')</label>
                        <div class="input-group">
                    ...
                    <div class="form-group">
                        <label for="mobileNumber">@lang('createcustomer.Mobile Number')</label>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                    ...
                    <div class="form-group">
                        <label for="street">@lang('createcustomer.Street')</label>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-globe"></i></span>
                    ...
                    <div class="form-group">
                        <label for="address1">@lang('createcustomer.Address 1')</label>
                        <div class="input-group">
                    ...
                    <div class="form-group">
                        <label for="address2">@lang('createcustomer.Address 2')</label>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-location-arrow"></i></span>
                    ...
                    <div class="form-group">
                        <label for="address2">@lang('createcustomer.houseno')</label>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-location-arrow"></i></span>
                    ...
                    <div class="form-group">
                        <label for="address2">@lang('createcustomer.societyname')</label>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-location-arrow"></i></span>
                    ...
                    <div class="form-group">
                        <label for="zipCode">@lang('createcustomer.Zip Code')</label>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-location-arrow"></i></span>
                    ...
                    <div class="form-group">
                        <label for="zipCode">@lang('createcustomer.Email')</label>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
...
<button type="submit" class="btn btn-flat bg-green btn-block save_form">@lang('createcustomer.' . $title)</button>
