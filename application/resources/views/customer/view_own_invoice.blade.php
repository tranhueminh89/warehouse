...
@section('title')
    {!!env('COMPANY_NAME')!!} | Invoice {{$invoice->invoiceNo}}
@endsection
                    ...
                    @if($invoice->paid == 0)
                        <a href="{{action('CustomerFrontendController@payInvoice', array('invoiceNumber'=>$invoice->invoiceNo))}}"
                           class="btn btn-flat bg-green "><i
                                    class="fa fa-paypal"></i> Pay Invoice</a>
                    @endif
                </div>
                <br/>
                <div class="">
            ...
            <div class="quote">
                <div id="details" class="clearfix">
                    ...
                    <div id="invoice">
                        ...
                        <div class="date">@lang('viewinvoice.All Cost in'): <b>{{$invoice->currencyTypeText}}</b></div>
                    </div>
                </div>
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th class="tax">@lang('viewinvoice.Tax')</th>
                    ...
                    <tr>
                        <td colspan="3"></td>
                        <td colspan="2">@lang('viewinvoice.SUBTOTAL')</td>
                        <td>{{number_format($invoice->items->sum('convertedPrice'),2)}}</td>
                    </tr>
                    <tr>
                        <td colspan="3"></td>
                        <td colspan="2">@lang('viewinvoice.TAX')</td>
                        <td> {{number_format($invoice->items->sum('tax'),2)}}</td>
                    </tr>
                    <tr>
                        <td colspan="3"></td>
                        <td colspan="2">@lang('viewinvoice.GRAND TOTAL')</td>
