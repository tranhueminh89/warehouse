...
@section('title')
    {!!env('COMPANY_NAME')!!} | @lang('createorder' . $title)
@endsection
@section('heading')
    {!! Helper::translateAndShorten($title,'createorder',50)!!}
@endsection
...
@section('content')
    ...
    <div id="purchaseOrder">
        <div class="row">
            <div class="col-md-4">
                <div class="form-group{!! $errors->has('supplierId') ? ' has-error' : '' !!}">
                    {!! Form::label('supplierId', trans('createorder.Supplier Name')) !!}
            ...
            <div class="col-md-4">
                <div class="form-group{!! $errors->has('lpoDate') ? ' has-error' : '' !!}">
                    {!! Form::label('lpoDate', trans('createorder.Lpo Date')) !!}
                    <div class="input-group">
            ...
            <div class="col-md-4">
                <div class="form-group{!! $errors->has('deliverBy') ? ' has-error' : '' !!}">
                    {!! Form::label('deliverBy', trans('createorder.Deliver By')) !!}
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default cls-panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            {!! Helper::translateAndShorten('Purchase Order Items','createorder',50)!!}
                        </h3>
                    </div>
                ...
                <div class="panel panel-default cls-panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            @lang('createorder.LPO Status')
                        </h3>
                    </div>

                    <div class="panel-body">
                        <div class="form-group{!! $errors->has('lpoStatus') ? ' has-error' : '' !!}">
                            {!! Form::label('lpoStatus',  trans('createorder.LPO Status') ) !!}
                            <div class="input-group">
                        ...
                        <div class="form-group{!! $errors->has('rejectionReason') ? ' has-error' : '' !!}">
                            {!! Form::label('rejectionReason',  trans('createorder.Rejection Reason') ) !!}
                            <div class="input-group">
        ...
        <div class="panel panel-default cls-panel">
            <div class="panel-heading">
                <h3 class="panel-title">
                    {!! Helper::translateAndShorten('Terms','createorder',40)!!}
                </h3>
            </div>
            ...
            <div class="panel-body">
                ...
                <div class="form-group{!! $errors->has('termsOfPayment') ? ' has-error' : '' !!}">
                    {!! Form::label('termsOfPayment', trans('createorder.Terms Of Payment')) !!}
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-file"></i></span>
                ...
                <div class="form-group{!! $errors->has('departmentId') ? ' has-error' : '' !!}">
                    {!! Form::label('departmentId', trans('createorder.Department')) !!}
                    <div class="input-group">
                ...
                <div class="form-group{!! $errors->has('remarks') ? ' has-error' : '' !!}">
                    {!! Form::label('remarks', trans('createorder.Remarks')) !!}
                    <div class="input-group">
