<div class="panel panel-default cls-panel">
    <div class="panel-heading">
        <h3 class="panel-title">
           @lang('createbinlocation.Add A Storage Location')
        </h3>
    </div>
    @if(isset($bin))
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group{!! $errors->has('warehouseName') ? ' has-error' : '' !!}">
                    {!! Form::label('warehouseName', trans('createbinlocation.Warehouse')) !!}
            ...
            <div class="col-md-6">
                <div class="form-group{!! $errors->has('binCode') ? ' has-error' : '' !!}">
                    {!! Form::label('binCode', trans('createbinlocation.Storage Location Name') ) !!}
                    <div class="input-group">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group{!! $errors->has('binDescription') ? ' has-error' : '' !!}">
                    {!! Form::label('binDescription', trans('createbinlocation.Storage Location Description')) !!}
                    <div class="input-group">
            ...
            <div class="col-md-6">
                <div class="form-group{!! $errors->has('binBarcode') ? ' has-error' : '' !!}">
                    {!! Form::label('binBarcode', trans('createbinlocation.Barcode')) !!}
                    <div class="input-group">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group{!! $errors->has('binMaxLevel') ? ' has-error' : '' !!}">
                    {!! Form::label('binMaxLevel', trans('createbinlocation.Bin Max Level')) !!}
                    <div class="input-group">
            ...
            <div class="col-md-6">
                <div class="form-group{!! $errors->has('binMaxWeight') ? ' has-error' : '' !!}">
                    {!! Form::label('binMaxWeight', trans('createbinlocation.Bin Max Weight')) !!}
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-archive"></i></span>
    ...
    <div class="panel-footer">
        <button type="submit" class="btn btn-flat bg-green btn-block">@lang('createbinlocation.Save')</button>
    </div>
    {!! Form::close() !!}
</div>