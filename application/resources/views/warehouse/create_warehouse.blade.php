...
@section('title')
    {!! env('COMPANY_NAME') !!} | @lang('createwarehouse.Create Warehouse')
@endsection
    ...
    <div class="panel panel-default cls-panel">
        <div class="panel-heading">
            <h3 class="panel-title">
                @lang('createwarehouse.Add A Warehouse')
            </h3>
        </div>
        @if(isset($warehouse))
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group{!! $errors->has('whsName') ? ' has-error' : '' !!}">
                        {!! Form::label('whsName', trans('createwarehouse.Warehouse Name')) !!}
                ...
                <div class="col-md-6">
                    <div class="form-group{!! $errors->has('whsStreet') ? ' has-error' : '' !!}">
                        {!! Form::label('whsStreet', trans('createwarehouse.Warehouse Street') ) !!}
                        <div class="input-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group{!! $errors->has('whsZipCode') ? ' has-error' : '' !!}">
                        {!! Form::label('whsZipCode', trans('createwarehouse.Warehouse Zip Code')) !!}
                        <div class="input-group">
                ...
                <div class="col-md-6">
                    <div class="form-group{!! $errors->has('whsCity') ? ' has-error' : '' !!}">
                        {!! Form::label('whsCity', trans('createwarehouse.Warehouse City')) !!}
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-building"></i></span>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group{!! $errors->has('whsState') ? ' has-error' : '' !!}">
                        {!! Form::label('whsState', trans('createwarehouse.Warehouse State')) !!}
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-location-arrow"></i></span>
                ...
                <div class="col-md-6">
                    <div class="form-group{!! $errors->has('whsBuilding') ? ' has-error' : '' !!}">
                        {!! Form::label('whsBuilding', trans('createwarehouse.Warehouse Building')) !!}
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-building"></i></span>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group{!! $errors->has('whsStoreKeeper') ? ' has-error' : '' !!}">
                        {!! Form::label('whsStoreKeeper', trans('createwarehouse.Store Keeper')) !!}
                        <div class="input-group">
                ...
                <div class="col-md-6">
                    <div class="form-group{!! $errors->has('isActive') ? ' has-error' : '' !!}">
                        {!! Form::label('isActive', trans('createwarehouse.Is Active')) !!}
                        <div class="input-group">
        ...
        <div class="panel-footer">
            <button type="submit" class="btn btn-flat save_form bg-green btn-block">@lang('createwarehouse.Save')</button>
        </div>
        {!! Form::close() !!}
    </div>
@endsection
