<div class="panel panel-default cls-panel">
    <div class="panel-heading">
        <h3 class="panel-title"> {!! Helper::translateAndShorten($titlePanel,'createdepartment',50)!!}</h3>
    </div>
    ...
    <div class="panel-body">
        <div class="form-group{!! $errors->has('name') ? ' has-error' : '' !!}">
            {!! Form::label('name',  trans('createdepartment.Department Name') ) !!}
        ...
        <div class="form-group{!! $errors->has('budgetStartDate') ? ' has-error' : '' !!}">
            ...
            <div class="input-group">
                ...
                {!! Form::text('budgetStartDate', null, ['class' => 'form-control']) !!}
            </div>
        ...
        <div class="form-group{!! $errors->has('budgetEndDate') ? ' has-error' : '' !!}">
            ...
            <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                {!! Form::text('budgetEndDate', null, ['class' => 'form-control']) !!}
            </div>
    ...
    <div class="panel-footer">
        <button type="submit" class="btn btn-flat bg-green btn-block save_form"> <i class="fa fa-users"></i> @lang('createdepartment.Save Department')</button>
        {!! Form::close() !!}
    </div>
</div>
