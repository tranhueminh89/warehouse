    ...
    <div class="panel panel-default cls-panel">
        ...
        <div class="panel-body">
            ...
            <div class="form-group{!! $errors->has('paymentDue') ? ' has-error' : '' !!}">
                {!! Form::label('paymentDue',  trans('Due Payment') ) !!}
                <div class="input-group">
            ...
            <div class="form-group{!! $errors->has('paymentCredit') ? ' has-error' : '' !!}">
                {!! Form::label('paymentCredit',  trans('Payment Credit') ) !!}
                <div class="input-group">
            ...
            <div class="form-group{!! $errors->has('paymentRemarks') ? ' has-error' : '' !!}">
                {!! Form::label('paymentRemarks', 'Payment Remarks') !!}
                <div class="input-group">
        ...
        <div class="panel-footer">
            <button type="submit" class="btn btn-flat bg-green btn-block">@lang('createpayment.Save')</button>
        </div>
        {!! Form::close() !!}
    </div>
