...
@section('title')
    {!!env('COMPANY_NAME')!!} | @lang('createpayment.Record Payment')
@endsection
@section('heading')
    @lang('createpayment.Create Payment')
@endsection
@section('content')
    ...
    <div class="panel panel-default cls-panel">
        ...
        <div class="panel-body">
            <div id="app">
                ...
                <div class="form-group{!! $errors->has('invoiceId') ? ' has-error' : '' !!}">
                    {!! Form::label('invoiceId',  trans('createpayment.Invoice Number') ) !!}
                    <div class="input-group">
                ...
                <div class="form-group{!! $errors->has('paymentAmount') ? ' has-error' : '' !!}">
                    {!! Form::label('paymentAmount',  trans('createpayment.Payment Amount') ) !!}
                    <div class="input-group">
                ...
                <div class="form-group{!! $errors->has('amountDue') ? ' has-error' : '' !!}">
                    {!! Form::label('amountDue',  trans('createpayment.Amount Due') ) !!}
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-money"></i></span>
                ...
                <div class="form-group{!! $errors->has('paymentMethod') ? ' has-error' : '' !!}">
                    {!! Form::label('paymentMethod',  trans('createpayment.Payment Method') ) !!}
                    <div class="input-group">
                ...
                <div class="form-group{!! $errors->has('paymentDetails') ? ' has-error' : '' !!}">
                    {!! Form::label('paymentDetails',  trans('createpayment.Payment Details') ) !!}
                    <div class="input-group">
        ...
        <div class="panel-footer">
            <button type="submit" class="btn btn-flat bg-green btn-block save_form">@lang('createpayment.Save')</button>
        </div>
        {!! Form::close() !!}
                ...
                watch: {
                    'customerid': function (val, oldVal) {
                        ...
                        this.$http.get('{{url('/payment/api/customer/')}}' + '/' + this.customerid).then(function (response) {
                            $("select[name='invoiceId']").select2().empty();
