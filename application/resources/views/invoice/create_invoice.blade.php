...
@section('title')
    {!!env('COMPANY_NAME')!!} | @lang('createinvoice.Create Invoice')
@endsection
...
@section('content')
    ...
    @if(isset($invoice))
        ...
        <script>
            ...
            window.invoiceId = {{ !empty($invoice->id) ? $invoice->id : 'null'}};
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group{!! $errors->has('invoiceDate') ? ' has-error' : '' !!}">
                    {!! Form::label('invoiceDate',  trans('createinvoice.Invoice Date') ) !!}
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group{!! $errors->has('salesOrderId') ? ' has-error' : '' !!}">
                    {!! Form::label('salesOrderId',  trans('createinvoice.Based on Sales Order') ) !!}
                    <div class="input-group">
                ...
                <div class="form-group{!! $errors->has('paymentMethod') ? ' has-error' : '' !!}">
                    {!! Form::label('paymentMethod',  trans('createinvoice.Payment Method') ) !!}
                    <div class="input-group">
                ...
                <div class="form-group{!! $errors->has('remark') ? ' has-error' : '' !!}">
                    {!! Form::label('remark',  trans('createinvoice.Remarks') ) !!}
                    <div class="input-group">
            ...
            <div class="col-md-6">
                <div class="form-group{!! $errors->has('emailCustomer') ? ' has-error' : '' !!}">
                    {!! Form::label('emailCustomer',  trans('createinvoice.Email Customer') ) !!}
                    <div class="input-group">
                ...
                <div class="form-group{!! $errors->has('paymentTerms') ? ' has-error' : '' !!}">
                    {!! Form::label('paymentTerms', 'Payment Terms') !!}
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-comment"></i></span>
    ...
    <button type="submit" class="btn btn-flat bg-green btn-block save_form">@lang('createinvoice.Save')</button>
    {!! Form::close() !!}
@endsection
