    ...
    <div id="content">
        ...
        <div class="page" style="font-size: 7pt">
            <table style="width: 100%;" class="header">
                <tr>
                    <td><h1 style="text-align: left">Generated On : {{\Carbon\Carbon::now()->format('Y-m-d H:i')}}</h1></td>
                    <td><h1 style="text-align: right">Done By : {{Auth::user()->name}}</h1></td>
                </tr>
            </table>

            <table style="width: 100%; font-size: 8pt;">
                <tr>
                    <!--<td>Customer: <strong>d</strong></td>-->
            ...
            <table class="change_order_items" style="page-break-inside: auto; page-break-inside: auto;">
                <tr>
                    <td  class="text-center" colspan="{{count($columns)}}"><h2>{{$reportSubTitle}}</h2></td>
                </tr>
                ...
                @foreach($model as $entry)
                    <tr class="even_row">
                        @foreach($columns as $column)
                            ...
                            <?php $property = $column['name']?>
                            <td style="">{{$entry->$property}}</td>
                        @endforeach
                    </tr>
                @endforeach
