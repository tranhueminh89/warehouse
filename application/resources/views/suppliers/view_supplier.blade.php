...
@section('title')
   {!! env('COMPANY_NAME') !!} | @lang('viewsupplier.View Supplier')
@endsection

@section('heading')
    @lang('viewsupplier.View Supplier')
@endsection
<style>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="box box-info delivery-box">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('viewsupplier.Deliveries')</h3>
                ...
                <div class="box-body chart-responsive">
                    ...
                    <table class="table no-margin">
                        <thead>
                        <tr>
                            <th>@lang('viewsupplier.Product Name')</th>
                            <th>@lang('viewsupplier.Restock Date')</th>
                            <th>@lang('viewsupplier.Amount')</th>
                            <th>@lang('viewsupplier.Price')</th>
                        </tr>
                        </thead>
                        <tbody>
                ...
                <div class="box-footer clearfix">
                    <a href="{!! url('supplier/download', ['id' => $id, 'fileType' => 'excel']) !!}" class="btn btn-sm btn-info btn-flat pull-left"><i class="fa fa-file-excel-o"></i> Excel
                        Report</a></a>
                    <a href="{!! url('supplier/download', ['id' => $id, 'fileType' => 'pdf']) !!}" class="btn btn-sm btn-default btn-flat pull-right"><i class="fa fa-file-pdf-o"></i> PDF
                        Report</a></a>
                </div>
            </div>
            <!-- /.box -->
        ...
        <div class="col-md-6">
            ...
            <div class="box box-info time-box">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('viewsupplier.Delivery Time')</h3>
                ...
                <div class="box-body chart-responsive">
                    ...
                    <table class="table no-margin">
                        <thead>
                        <tr>
                            <th>@lang('viewsupplier.LPO Number')</th>
                            <th>@lang('viewsupplier.LPO Date')</th>
                            <th>@lang('viewsupplier.Delivered')</th>
                            <th>@lang('viewsupplier.Delivery Time')</th>
                        </tr>
                        </thead>
                        <tbody>
