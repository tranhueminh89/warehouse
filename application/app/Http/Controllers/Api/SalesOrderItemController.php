...
class SalesOrderItemController extends Controller
{
    ...
    public function show($id, Request $request)
    {
        ...
        $product['productTax'] = !empty($product['productTax']) ? $product['productTax'] : 0;
        $product['productTaxRate'] = !empty($product['productTaxRate']) ? $product['productTaxRate'] : 0;
        $product['taxRate'] = !empty($product['taxRate']) ? $product['taxRate'] : 0;
