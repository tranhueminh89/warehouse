...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return View('products/create_product')->with(compact('products', 'serials', 'title'));
    }
    ...
    public function edit($id)
    {
        ...
        return View('products/create_product')->with(compact('product', 'products', 'serials', 'gridData', 'title'));
...
//        $img->insert($logo,'bottom');
    ...
    {
        return View('products/view_outofstock_products');
    }
