...
class DepartmentController extends Controller
{
    ...
    public function create()
    {
        ...
        $titlePanel = "Add A Department";

        return View('departments/newdepartment')->with('title', $title)->with('titlePanel', $titlePanel);
    }
    ...
    public function show($id)
    {
        ...
        return view('departments.view_department')->with(compact('department'));
    ...
    public function edit($id)
    {
        ...
        $titlePanel = "Edit A Department";
        $this->authorize('view', $department);

        return View('departments/newdepartment')->with(compact('departments'))
                                                ->with(compact('department'))
                                                ->with('title', $title)
                                                ->with('titlePanel', $titlePanel);
    }
