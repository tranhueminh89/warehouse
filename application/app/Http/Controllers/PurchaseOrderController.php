...
class PurchaseOrderController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('purchaseorder.create_purchaseorder')->with(compact('product', 'departments', 'requestNo', 'prevCurr', 'title'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('purchaseorder.create_purchaseorder')->with(compact('purchaseorder', 'orders', 'prevCurr', 'title'));
    }
