...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        $title = "Create User";
        $titlePanel = "Create A User";

        return view('users.createupdateuser')->with(compact('title', 'titlePanel'));
    }
    ...
    public function edit($id)
    {
        ...
        $title = "Edit User";
        $titlePanel = "Edit A User";

        return view('users.createupdateuser')->with(compact('user', 'title', 'titlePanel'));
    }
    ...
    public function getDeleted()
    {
        ...
        return view('users.view_users_deleted')->with(compact('users', 'restore', 'message'));
    }
    ...
    public function import(Request $request)
    {
        ...
        $columns = array_except($columns, 'createdBy', 'deleted_at', 'created_at', 'updated_at');
